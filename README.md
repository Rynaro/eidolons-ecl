...
- **Latest stable:** [ECL v1.0](spec/ecl-1.0.md) (also reachable as
...
1. **The normative spec** in [`spec/ecl-1.0.md`](spec/ecl-1.0.md). RFC 8174
...
See [§7 of the spec](spec/ecl-1.0.md#7--versioning--compatibility) for the full
promotion timeline.
